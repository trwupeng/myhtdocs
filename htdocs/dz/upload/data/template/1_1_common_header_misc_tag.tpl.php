...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1480640912, '1', './data/template/1_1_common_header_misc_tag.tpl.php', './template/default', 'common/header_misc_tag')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1480640912, '1', './data/template/1_1_common_header_misc_tag.tpl.php', './template/default', 'common/header_misc_tag')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1480640912, '1', './data/template/1_1_common_header_misc_tag.tpl.php', './template/default', 'common/header_misc_tag')
;?>
