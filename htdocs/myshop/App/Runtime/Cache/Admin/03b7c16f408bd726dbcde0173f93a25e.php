...
<div class="main-div">
  <form action="/index.php/Admin/Admin/update" method="post" name="theForm" enctype="multipart/form-data">
  <table width="100%" id="general-table">
      <tr>
       ...
       <tr>
        ...
        <td>
          <input type='text' name='password'/> <font color="red">如果不输入则使用原来的密码</font>
        </td>
      </tr>
      <tr>
        <td class="label">确认密码:</td>
        <td>
          <input type='text' name='rpassword'/> <font color="red">*</font>
        </td>
      </tr>
      <tr>
        ...
        <td>
                <select name="role_id">
                        <option>选择角色</option>
                      <?php foreach($roledata as $v){ if($v['id']==$info['role_id']){ $sel='selected="selected"'; } ?>
