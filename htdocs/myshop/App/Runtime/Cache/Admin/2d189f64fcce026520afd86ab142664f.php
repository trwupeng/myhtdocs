...
<h1>
<span class="action-span"><a href="<?php echo U('add')?>">添加角色权限</a></span>
<span class="action-span1"><a href="#">MYHOME 管理中心</a> </span><span id="search_id" class="action-span1"> - 角色分类 </span>
...
<table width="100%" cellspacing="1" cellpadding="2" id="list-table">
  ...
  <?php foreach($roledata as $v){?>
    ...
    <td width="20%"><?php echo $v['priv_list']?></td>
    
    <td width="40%" align="center">
      <a href="<?php echo U('add',array('id'=>$v['id']))?>">角色列表</a> |
      <a href="#">编辑</a> |
      <a href="<?php echo U('del',array('id'=>$v['id']))?>" onclick='return confirm("确定要删除吗？")' title="移除">移除</a>
    </td>
  </tr>
  <?php }?>  
  </table>
