...
<h1>
<span class="action-span"><a href="/myshop/index.php/Admin/Category/add">添加栏目</a></span>
...
<table width="100%" cellspacing="1" cellpadding="2" id="list-table">
  ...
  <?php foreach($catedata as $v){?>
    ...
    <td align="left" class="first-cell" style = 'padding-left="0"'>
            <?php echo str_repeat('&nbsp;',$v['lev']*4);?><img src="/myshop/Public/Admin/images/menu_minus.gif" id="icon_0_1" width="9" height="9" border="0" style="margin-left:0em" />

            <span><a href="#" ><?php echo $v['cat_name']?></a></span>
        </td>
    <td width="10%">0</td>
    <td width="10%"><span>&nbsp;&nbsp;&nbsp;&nbsp;</span></td>
    <td width="10%"><img src="/myshop/Public/Admin/images/no.gif" /></td>
    <td width="10%"><img src="/myshop/Public/Admin/images/yes.gif" /></td>
    <td><span>5</span></td>
    ...
    <td width="24%" align="center">
      ...
      <a href="<?php echo U('del',array('id'=>$v['id']))?>" title="移除" onclick="return confirm('你确定要删除吗')">移除</a>
    </td>
  </tr>
  <?php }?> 
  </table>
