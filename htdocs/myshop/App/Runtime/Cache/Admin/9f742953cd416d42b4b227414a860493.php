...
<h1>
    <span class="action-span"><a href="<?php echo U('lst')?>">权限分类</a></span>
<span class="action-span1"><a href="#">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1"> - 添加商品类型 </span>
<div style="clear:both"></div>
</h1>

<div class="main-div">
  <form action="/admin.php/Admin/Privilege/add" method="post" name="theForm" enctype="multipart/form-data">
