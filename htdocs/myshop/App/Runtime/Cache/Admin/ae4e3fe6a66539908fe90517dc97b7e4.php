...
<div class="main-div">
  <form action="/index.php/Admin/Role/add" method="post" name="theForm" enctype="multipart/form-data">
  <table width="100%" id="general-table">
      ...
      <tr>
        ...
        <?php foreach($privdata as $v){?>
          <input type='checkbox' name='priv_id[]' value="<?php echo $v['id']?>"/><?php echo str_repeat('--',$v['lev']).$v['priv_name']?><br/>
          <?php }?>
        </td>
      </tr>
      <tr>
