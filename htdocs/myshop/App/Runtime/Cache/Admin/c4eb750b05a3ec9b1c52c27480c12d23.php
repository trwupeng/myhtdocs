...
<script type="text/javascript" src="/myshop/Public/Js/ueditor/ueditor.config.js"></script>
<script type="text/javascript" src="/myshop/Public/Js/ueditor/ueditor.all.min.js"></script>
<script type="text/javascript" src="/myshop/Public/Js/ueditor/lang/zh-cn/zh-cn.js"></script>
...
$(function(){
    $('select[name=goods_type_id]').change(function(){
            ...
            $.ajax({
                    type:'get',
                    url:'/myshop/index.php/Admin/Goods/showAttr/goods_type_id/'+goods_type_id,
...
<div class="tab-div">
    ...
    <!-- tab body -->
    <div id="tabbody-div">
      <form enctype="multipart/form-data" action="/myshop/index.php/Admin/Goods/add.html" method="post" name="theForm" >
        <!-- 最大文件限制 -->
        ...
        <table width="90%" id="general-table" align="center">
          ...
          <tr>
            <td class="label">
            <a href="#" title="点击此处查看提示信息"><img src="/myshop/Public/Admin/images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a> 商品货号： </td>
        ...
        <table width="90%" id="mix-table" style="display:none" align="center">
          ...
          <tr>
            <td class="label"><a href="#" title="点击此处查看提示信息"><img src="/myshop/Public/Admin/images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a> 商品库存数量：</td>
          ...
          <tr>
            <td class="label">
            <a href="#" title="点击此处查看提示信息"><img src="/myshop/Public/Admin/images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a> 商家备注： </td>
   ...
   <!-- 商品相册 -->
        <table width="90%" id="album-table" style="display:none">
          <tr>
                <td>
                        <ul>
                            <li><a href="javascript:" onclick="copyalbum(this)">[+]</a>上传文件：<input type="file" name="goods_album[]"/></li>
                        </ul>
                </td>
          </tr>
        </table>
...
function copyalbum(o){
        //取出当前li标签
        var lis = $(o).parent();
        //要判断a标签里面的内容，如果是[+]则要自我复制，如果是[-]则自我消失
        if($(o).html()=='[+]'){
                //自我复制
                var new_lis = lis.clone();//克隆新的li
                //把新的li中的a的标签的内容改成[-]
                new_lis.find('a').html('[-]');
                //把新的li放到当前li的后面
                lis.after(new_lis);
