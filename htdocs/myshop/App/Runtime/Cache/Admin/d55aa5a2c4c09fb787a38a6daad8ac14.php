...
<table width="100%" cellspacing="1" cellpadding="2" id="list-table">
  ...
  <?php foreach($admindata as $v){ if($v['id']==1){ continue; } ?>
    ...
    <td width="20%"><?php echo $v['role_name']?></td>
    
    <td width="40%" align="center">
      <a href="<?php echo U('update',array('id'=>$v['id']))?>">编辑</a> |
      <a href="<?php echo U('del',array('id'=>$v['id']))?>" title="移除" onclick="return confirm('你确定要删除吗')" title="移除">移除</a>
    </td>
  </tr>
  <?php }?>  
  </table>
