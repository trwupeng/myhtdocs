                    ...
                    <div class="usBox_2 clearfix">
                        ...
                        <form id="yw0" action="/index.php/Home/User/register" method="post">                <table cellpadding="5" cellspacing="3" style="text-align:left; width:100%; border:0;">
                                <tbody>
                                    ...
                                    <tr>
                                        <td align="right"><label for="User_user_qq">问题</label></td>
                                        <td>
                                            <input class="inputBg" size="25" name="question" id="User_user_qq" type="text" value="" />找回密码用
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right"><label for="User_user_tel">答案</label></td>
                                        <td>
                                            <input class="inputBg" size="25" name="answer" id="User_user_tel" type="text" value="" />找回密码用
                                        </td>
                                    </tr>
