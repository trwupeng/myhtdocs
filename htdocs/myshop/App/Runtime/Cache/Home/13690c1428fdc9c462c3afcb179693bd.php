            ...
            $(function(){
                    ...
                    $(".incr").click(function(){
                        ...
                        var _this = $(this);
                          $.ajax({
                                    type:'get',
                                    url:'/myshop/index.php/Home/Cart/updateCart/goods_id/'+goods_id+'/goods_attr_id/'+goods_attr_id,
        ...
        <div class="block">
            <div class="flowBox">
                    ...
                    <table cellpadding="5" cellspacing="1">
                        <tbody><tr>
                            ...
                            <tr>
                                ...
                                <td align="right">
                                    <a href="javascript:" class="decr"><img src="/myshop/Public/Home/images/decr.gif"/></a>
                                    ...
                                    <a href="javascript:" class="incr"><img src="/myshop/Public/Home/images/incr.gif"/></a>
                ...
                <table cellpadding="5" cellspacing="0" width="99%">
                    <tbody><tr>
                            <td><a href="#"><img src="/myshop/Public/Home/images/continue.gif" alt="continue" /></a></td>
                            <td align="right"><a href="<?php echo U('Order/checkout')?>"><img src="/myshop/Public/Home/images/checkout.gif" alt="checkout" /></a></td>
                        </tr>
                    </tbody></table>
            </div>
            <div class="blank"></div>
        ...
        <div id="bottomNav" class="box block">
            <div class="box_1">
                <div class="links clearfix"> 
                    <a href="#" target="_blank" title="YONGDA商城"><img src="/myshop/Public/Home/images/flow.htm" alt="YONGDA商城" /></a>
