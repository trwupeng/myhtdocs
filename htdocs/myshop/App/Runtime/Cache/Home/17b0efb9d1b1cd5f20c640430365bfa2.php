...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div class="block box">
            <div class="blank"></div>
            <div id="ur_here">
                当前位置: <a href="/index.php">首页</a> <code>&gt;</code> 用户中心 
            </div>
        </div>
                ...
                <div class="box">
                    <div class="box_1">
                        <div class="userCenterBox boxCenterList clearfix" style="">
                            ...
                            <div class="blank"></div>
                            <form action="/index1.php/Home/Order/writeAddress" method="post" name="theForm">
                                <table bgcolor="#dddddd" border="0" cellpadding="5" cellspacing="1" width="100%">
                                    <tbody><tr>
                                        ...
                                        <tr>
                                            ...
                                            <td align="left" bgcolor="#ffffff">
                                                <input name="post" class="inputBg" id="zipcode_0" value="232322" type="text" /></td>
                                        </tr>
                                        <tr>
