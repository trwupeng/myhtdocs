    ...
    <body>
        ...
        <div class="block">
            <div class="flowBox" style="margin: 0pt auto 70px;">
                ...
                <p style="text-align: center; margin-bottom: 20px;">您可以 <a href="#">返回首页</a> 或去 <a href="__ZHIFU__/tijiao.php">用户结算中心</a></p>
            </div>
        </div>
        ...
        <div id="bottomNav" class="box block">
            <div class="box_1">
                <div class="links clearfix"> 
                    <a href="#" target="_blank" title="YONGDA商城"><img src="/Public/Home/images/flow.htm" alt="YONGDA商城" border="0" /></a>
