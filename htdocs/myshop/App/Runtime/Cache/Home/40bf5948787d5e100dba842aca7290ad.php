        ...
        <div class="block block1">
            ...
            <div class="usBox clearfix">
                <div class="usBox_1 f_l">
                    ...
                    <form name="formLogin" action="/index.php/Home/User/logout" method="post">
                        <table align="left" border="0" cellpadding="3" cellspacing="5" width="100%">
                            <tbody><tr>
                                ...
                                <tr><td></td><td><a href="<?php echo U('User/findPass1')?>" class="f3">密码问题找回密码</a>&nbsp;&nbsp;&nbsp;<a href="#" class="f3">注册邮件找回密码</a></td></tr>
                            </tbody></table>
                    </form>
                    <div class="blank"></div>
                </div>
