...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div class="block">
            <form action="/index.php/Home/Order/flow" method="post" name="theForm" id="theForm" >
                <div class="flowBox">
                ...
                <div class="flowBox">
                    ...
                    <table cellpadding="5" cellspacing="1" width="99%">
                        <tbody><tr>
                                <td>收货人姓名:</td>
                                <td><?php echo $consigneeinfo['consignee']?></td>
                                <td>电子邮件地址:</td>
                                <td>shuhua141@163.com</td>
                            </tr>
                            <tr>
                                <td>详细地址:</td>
                                <td><?php echo $consigneeinfo['address']?> </td>
                                <td>邮政编码:</td>
                                <td><?php echo $consigneeinfo['post']?></td>
                            </tr>
                            <tr>
                                <td>电话:</td>
                                <td>110 </td>
                                <td>手机:</td>
                                <td><?php echo $consigneeinfo['mobile']?></td>
                            </tr>
                            <tr>
                                <td>标志建筑:</td>
                                <td>朝阳门</td>
                    ...
                    <table id="paymentTable" cellpadding="5" cellspacing="1" width="99%">
                        <tbody><tr>
                            ...
                            <tr>
                                ...
                                <td valign="top">使用在线支付，需要开通网上银行</td>
                                <td align="right" valign="top">￥0.00元</td>
                            </tr>
                            <tr>
                                <td valign="top"><input name="payment" value="3" iscod="0" type="radio" /></td>
                            ...
                            <tr>
                                <td valign="top"><input name="payment" value="4" iscod="1" disabled="true" type="radio" /></td>
                ...
                <div class="flowBox">
                    ...
                    <input type="hidden" name="consignee" value="<?php echo $consigneeinfo['consignee']?>"/>
                    <input type="hidden" name="address" value="<?php echo $consigneeinfo['address']?>"/>
                    <input type="hidden" name="mobile" value="<?php echo $consigneeinfo['mobile']?>"/>
