...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title><?php echo $goodsinfo['goods_name']?></title>
    ...
    <body style="cursor: auto;">
        ...
        <div class="block box">
            ...
            <div id="ur_here">
                ...
                <?php foreach($familydata as $v){?>
                <code>&gt;</code> <a href="<?php  echo U('Index/category',array('id'=>$v['id']))?>"><?php echo $v['cat_name']?></a>
                <?php }?>
                
                <code>&gt;</code> <?php echo $goodsinfo['goods_name']?>    
            </div>
        </div>
        <div class="blank"></div>
        ...
        <div class="block clearfix">
                ...
                <div style="display: block;" class="box" id="history_div">
                    ...
                    <div class="box_1">
                        ...
                        <div class="boxCenterList clearfix" id="history_list">
                            <ul class="clearfix"><li class="goodsimg"><a href="#" target="_blank"><img src="/myshop/Public/Home/images/8_thumb_G_1241425513488.jpg" alt="飞利浦9@9v" class="B_blue"></a></li><li><a href="#" target="_blank" title="飞利浦9@9v">VIVO X6PLUS</a><br />本店售价：<font class="f1">￥2388元</font><br /></li></ul><ul class="clearfix"><li class="goodsimg"><a href="#" target="_blank"><img src="/myshop/Public/Home/images/9_thumb_G_1241511871555.jpg" alt="诺基亚E66" class="B_blue"></a></li><li><a href="#" target="_blank" title="诺基亚E66">OPPO R9</a><br />本店售价：<font class="f1">￥2788元</font><br /></li></ul><ul class="clearfix"><li class="goodsimg"><a href="#" target="_blank"><img src="/myshop/Public/Home/images/17_thumb_G_1241969394587.jpg" alt="夏新N7" class="B_blue"></a></li><li><a href="#" target="_blank" title="夏新N7">iphone 6S</a><br />本店售价：<font class="f1">￥5288元</font><br /></li></ul><ul id="clear_history"><a onclick="clear_history()">[清空]</a></ul>  </div>
                    </div>
                </div>
                <div class="blank5"></div>
            </div>
            ...
            <div class="AreaR">
                <div id="goodsInfo" class="clearfix">
                    <div class="imgInfo">
                        <a style="position: relative; display: block; outline: 0pt none; text-decoration: none; width: 310px; -moz-user-select: none;" href="/myshop/Public/Home/images/200905/goods_img/9_P_12415118715751.jpg" id="zoom1" class="MagicZoom MagicThumb" title="诺基亚E66">
                            <img id="sim806035" src="<?php echo C('IMG_SRC').$goodsinfo['goods_img']?>" alt="诺基亚E66" height="310px" width="310px;" />
                            <div class="MagicZoomBigImageCont" style="width: 200px; height: 269px; overflow: hidden; z-index: 100; visibility: visible; position: absolute; top: -10000px; left: 327px; display: block;" id="bc806035">
                                ...
                                <div style="overflow: hidden;">
                                    <img style="position: relative; border-width: 0px; padding: 0px; left: 0px; top: 0px; display: block; visibility: visible;" src="/myshop/Public/Home/images/9_P_1241511871575.jpg" />
                                </div>
                        ...
                        <div style="text-align: center; position: relative; width: 100%;">
                            <a href="#">
                                <img style="position: absolute; left: 0pt;" alt="prev" src="/myshop/Public/Home/images/up.gif" /></a>
                            <a href="javascript:;" onclick="window.open('gallery.php?id=9'); return false;">
                                <img alt="zoom" src="/myshop/Public/Home/images/zoom.gif" />
                            </a>
                            <a href="#">
                                <img style="position: absolute; right: 0pt;" alt="next" src="/myshop/Public/Home/images/down.gif" /></a>
                        </div>
                        <div class="blank5"></div>

                        <div class="picture" id="imglist">
                            <a style="outline: 0pt none;" href="/myshop/Public/Home/images/200905/goods_img/9_P_1241511871575.jpg" rel="zoom1" rev="images/200905/goods_img/9_P_1241511871575.jpg" title="">
                                <img src="<?php echo C('IMG_SRC').$goodsinfo['goods_thumb']?>" alt="诺基亚E66" class="onbg" /></a>
                        </div>
                    </div>
                    ...
                    <div class="textInfo">
                        <form action="<?php echo U('Cart/addCart')?>" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY">
                            ...
                            <ul>
                               ...
                               <!-- <li class="clearfix">
                                    <dd>
                                        <strong>商品品牌：</strong><a href="#"><?php echo $goodsinfo['']?></a>
                                    </dd>
                                </li>  <-->
                                <li class="clearfix">
                                    <dd>
                                ...
                                <li class="clearfix">
                                    <dd>
                                        <strong>上架时间：</strong><?php echo date('Y-m-d',time())?>    
                                    </dd>
                                </li>
                                <li class="clearfix">
                                    <dd>
                                ...
                                <li class="clearfix">
                                    <dd>
                                        ...
                                        <strong>注册用户：</strong><font class="shop" id="ECS_RANKPRICE_1">￥<?php echo $goodsinfo['shop_price']*0.95?>    元</font><br />
                                        <strong>vip：</strong><font class="shop" id="ECS_RANKPRICE_2">￥<?php echo $goodsinfo['shop_price']*0.8?>    元</font><br />
                                    </dd>
                                </li>
                                <li class="clearfix">
                                    <dd>
                                        <strong>用户评价：</strong>
                                        <img src="/myshop/Public/Home/images/stars5.gif" alt="comment rank 5">
                                    </dd>
                                </li>
                                <li class="padd">
                        ...
                        <?php foreach($radiodata as $v){?>
                            ...
                            <?php }?>
                                ...
                                <input type="hidden" name="goods_id" value="<?php echo $goodsinfo['id']?>" />
                                    <a href="javascript:" onclick="addCartSubmit()"><img src="/myshop/Public/Home/images/goumai2.gif"></a>
                                    <a href="#"><img src="/myshop/Public/Home/images/shoucang2.gif"></a>
                                    <a href="#"><img src="/myshop/Public/Home/images/tuijian.gif"></a>
                                </li>
                            </ul>
                        </form>
                    </div>
                ...
                <div class="box">
                    <div class="box_1">
                        ...
                        <?php echo $goodsinfo['goods_desc']?> 
                           <!-- <p>在机身材质方面,<?php echo $goodsinfo['goods_name']?>大量采用金属材质，刨光的金属表面光泽动人，背面的点状效果规则却又不失变化，时尚感总是在不经意间诠释出来，并被人们所感知。<?php echo $goodsinfo['goods_name']?>机身尺寸为<span style="color:red;"><span style="font-size: larger;"><strong>107.5×49.5×13.6毫米，重量为121克</strong></span></span>，滑盖的造型竟然比E71还要轻一些。</p>
                            <p>&nbsp;</p>
                ...
                <div class="box">
                    <div class="box_1">
                        ...
                        <div class="boxCenterList clearfix ie6">
                            <div class="goodsItem">
                                <a href="#">
                                    <img src="/myshop/Public/Home/images/17_thumb_G_1241969394587.jpg" alt="P806" class="goodsimg"></a><br />
                                <p><a href="#" title="P806">ipone6s</a></p> 
                                <font class="shop_s">￥5288元</font>
                            </div>
                            <div class="goodsItem">
                                <a href="#">
                                    <img src="/myshop/Public/Home/images/9_thumb_G_1241511871555.jpg" alt="多普达Touch HD" class="goodsimg" /></a><br />
                                <p><a href="#" title="多普达Touch HD">OPPO R9</a></p> 
                                <font class="shop_s">￥2788元</font>
                            </div>
                            <div class="goodsItem">
                                <a href="#">
                                    <img src="/myshop/Public/Home/images/8_thumb_G_1241425513488.jpg" alt="诺基亚5320 XpressMusic" class="goodsimg" /></a><br />
                                <p><a href="#" title="诺基亚5320 XpressMusic">VIVO X6PLUS</a></p> 
                                <font class="shop_s">￥2388元</font>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="ECS_BOUGHT"><div class="box">
                        <div class="box_1">
                            <h3><span class="text">购买记录</span>(近期成交数量<font class="f1">1000</font>)</h3>
                                ...
                                2016/03/09  
                                 ...
                                 <div id="buy_pagebar" class="f_r" style="margin-top: 10px;">
                                    <form name="selectPageForm" action="/goods.php" method="get">
                                        <div id="buy_pager">
                                            总计 1000 个记录，共 10页。 <span> <a href="#">第一页</a> <a href="#">上一页</a> <a href="#">下一页</a> <a href="#">最末页</a> </span>
                                        </div>
                                    </form>
                                </div>
                    ...
                    <div class="blank5"></div></div><div id="ECS_COMMENT"> <div class="box">
                        <div class="box_1">
                            <h3><span class="text">用户评论</span>(共<font class="f1">522</font>条评论)</h3>
                            <div class="boxCenterList clearfix" style="height: 1%;">
                                <ul class="comments">
                                    <li>非常好,已经购买多部，下次还要来。</li>
                                    <li>第一次购买，非常满意。</li>
                                    <li>此用户没有评价。</li>
                                    <li>朋友推荐过来的，比较几家，还是这家最划算。</li>
                                    <li>非常满意的一次购物，快递小哥，非常给力。</li>
                                    <li>此用户没有评价。</li>
                                </ul>
                                ...
                                <div id="pagebar" class="f_r">
                                    <form name="selectPageForm" action="/goods.php" method="get">
                                        <div id="pager">
                                            总计 522个记录，共 17页。 <span> <a href="#">第一页</a> <a href="#">上一页</a> <a href="#">下一页</a> <a href="#">最末页</a> </span>
                                        </div>
                                    </form>
                                </div>
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        <div style="padding-left: 15px; text-align: left; float: left;">
                                                            ...
                                                            <img src="/myshop/Public/Home/images/captcha.png" alt="captcha" onclick="this.src='captcha.php?'+Math.random()" class="captcha" />
                                                        </div>
        ...
        <div id="bottomNav" class="box block">
            <div class="box_1">
                <div class="links clearfix"> 
                    <a href="#" target="_blank" title="YONGDA商城"><img src="/myshop/Public/Home/images/goods.htm" alt="YONGDA商城" border="0" /></a>
        ...
        <img class="MagicThumb-image" style="position: absolute; top: -9999px; display: none;" src="/myshop/Public/Home/images/9_P_1241511871575.jpg" />
        <img src="/myshop/Public/Home/images/controlbar.htm" style="position: absolute; top: -999px;" />
        <img style="position: absolute; left: -10000px; top: -10000px;" src="/myshop/Public/Home/images/9_P_1241511871575.jpg" />
        <img style="position: absolute; left: -10000px; top: -10000px;" src="/myshop/Public/Home/images/9_P_1241511871575.jpg" />
    </body>
</html>
<script>
